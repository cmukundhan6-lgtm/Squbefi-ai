      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          <div className="md:col-span-1">
            <Link href="/" className="font-mono font-bold text-2xl text-primary tracking-tight mb-4 inline-block">
              Squebefi AI
            </Link>
            <p className="text-muted-foreground text-sm leading-relaxed max-w-xs mb-6">
              Automate Everything.<br />Understand Everything.<br />
              The enterprise AI data automation platform built like a weapon.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">DPA</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Squebefi AI Inc. All rights reserved.
          </p>
